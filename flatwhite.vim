...
call s:hi ("Search",		s:base7,					s:accent,		"none")
...
call s:hi ("StatusLine",	s:base7,			s:white,		"bold")
call s:hi ("StatusLineNC",	s:base1,			s:base7,		"none")
